...
class Datafeed(object):
    ...
    currencys = ['EURUSD', 'GBPUSD', 'USDCAD', 'USDJPY', '@EP', '@ENQ', '@YM', '@RTY','@USA', '@DD',
                 '@DSX', '@CLE','@DB',]
...
class Conditions(Datafeed):
    ...
    def con_acc(self):
        ...
        #######################
        self.cons_D['acc'] = ((self.cons_D['con_rsi3'])& (self.cons_D['con_rsi14_add']) & (self.cons_D['all_trend_tfs']))
...
class Eng(Datafeed):
    ...
    def eng_con_1(self, rsi, rsi_level):
        ...
        self.cons_eng_D['acc_prime' + '_' + str(rsi)] = (self.df['rsi_tf' + str(self.TF) + '_' + str(rsi)].shift(
            +1) < 100 - rsi_level) & (self.df['close_tf' + str(self.TF)].shift(+1) < self.df[
            'ema_tf' + str(self.TF) + '_20'].shift(+1)) & (self.df['close_tf' + str(self.TF)].shift(+1) < self.df[
        ...
        self.cons_eng_D['acc_prime_2' + '_' + str(rsi)] = (self.df['rsi_tf' + str(self.TF) + '_' + str(rsi)].shift(
            +1) < 100 - rsi_level) & (
                                                                  ...
                                                                  self.df[
                                                                      'ema_tf' + str(self.TF) + '_20'].shift(+1)) & (
                                                                  self.df['close_tf' + str(self.TF)].shift(+1) <
                                                                  self.df[
                                                                      'ema_tf' + str(self.TF) + '_50'].shift(+1))
